...
export const Footer = () => (
  <Box py={{ base: '12', md: '16' }} mt={10} px={5} boxShadow= "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" >
    <Stack spacing={{ base: '4', md: '5' }}>
      <Stack justifyContent={"space-between"} direction="row" align="center">
        ...
        <ButtonGroup variant="ghost">
          ...
          />
          <IconButton as="a" href="https://github.com/anubhav021996" target="_blank" aria-label="GitHub" icon={<FaGithub fontSize="1.25rem" />} />
          <IconButton
            as="a"
