...
const navItems = [
  {
    name: "Goblet of Products",
    img: "https://res.cloudinary.com/dyocvbqbf/image/upload/v1667925047/Manuals/HD-wallpaper-harry-potter-harry-potter-and-the-goblet-of-fire_copy_bunsjf.jpg",
  },
  {
  ...
  {
    name: "Weasleys' Wheezes",
    img: "https://res.cloudinary.com/dyocvbqbf/image/upload/v1667925055/Manuals/20160804-DSC_0695-1536x1024_copy_uj9b6i.jpg",
  },
  {
    name: "Sweet Trolley",
    img: "https://res.cloudinary.com/dyocvbqbf/image/upload/v1667925046/Manuals/855edda8-bbf4-45e9-bb6f-116e24c1bc5f-resize-950x633_dfnxdm.webp",
  },
];
      ...
      <Box bg={useColorModeValue("gray.100", "gray.900")} px={4}>
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <Flex alignItems={"center"}>
            ...
            <Box mr={{ md: 5, lg: 0 }}>
              {token ? (
                <UserIcon logout={handleLogout} />
              ) : (
                <Login login={() => Navigate("/login")} />
              )}
            </Box>
          </Flex>
        </Flex>
