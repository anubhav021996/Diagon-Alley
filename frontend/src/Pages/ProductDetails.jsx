...
export const ProductDetails = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/product/${state.id}`)
      .then((res) => {
        setProduct(res.data);
        setLoading(false);
      });
      ...
      >
        ...
        <Stack spacing={{ base: 6, md: 10 }}>
          ...
          <Stack
            ...
            direction={"column"}
            divider={
              <StackDivider borderColor={mode("gray.200", "gray.600")} />
            }
          >
            {loading ? (
              <Skeleton h={500} w={1000} />
          ...
          <Button
            ...
            disabled={!product.quantity || product._id in obj || addCart}
