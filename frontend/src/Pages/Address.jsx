...
export const Address= () => {
    ...
    return (
      ...
      <Stack align={'center'} p="4" >
        ...
        {loading ? <Skeleton h={400} w={1200} m={10}  /> : 
      ...
      {address?.map((e,i)=>(
        ...
        <Button width={"100%"} variant="outline" colorScheme="green" disabled={del} onClick={()=>Navigate("/updateAddress",{state:{index:i}})}>
              Update Address
            </Button>
            <Button width={"100%"} colorScheme="green" disabled={del} onClick={()=>deleteAdd(i)}>Delete Address</Button>
      </Stack>
      ))}
      </Box>}
